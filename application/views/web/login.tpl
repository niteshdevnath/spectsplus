                            ...
                            <div class="left-content-area">  
                                ...
                                <div class="bottom-content">
                                    ...
                                    <div class="right-content">
                                        <ul>
                                            <li>
                                                <a style="background-color: cornflowerblue; color:white;" href="#"><i class="fa fa-facebook" aria-hidden="true"></i> Facebook</a>    
                                            </li>  
                                            <li>
                                                <a href="#" style="background-color:#1DA1F2; color:white;"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a>
                                            </li>
                                            <li>
                                                <a style="background-color: salmon; color:white;" href="#"><i class="fa fa-google" aria-hidden="true"></i> Google</a>
                                            </li>
                                        </ul>
                                    </div>  
                                </div>   
